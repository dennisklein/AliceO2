...
function(o2_add_test_root_macro)
  ...
  foreach(t IN LISTS A_PUBLIC_LINK_LIBRARIES)
    if(NOT TARGET ${t})
      message(
        WARNING
          "Trying to use non-existing target ${t} for ${testName} test so I won't be able to generate the required test"
        )
      return()
    endif()
  ...
  foreach(t IN LISTS dependencies)
    ...
    # LD_LIBRARY_PATH o2_get_rpath(${t} RPATH rpath) list(APPEND libdir
    # ${rpath})
  endforeach()
